...
async function seed() {
  ...
  const sampleExpenses = [
    ...
    { title: "Performance Bonus - Q1", category: "BONUS" as Category, amount: 1000.00, paymentMethod: "BANK_TRANSFER" as PaymentMethod, paidTo: ahmad?.fullName ?? "Ahmad Rahimi", paidBy: fatima?.fullName ?? "Finance", paidById: fatima?.id ?? null, paidToId: ahmad?.id ?? null, paidToContractorId: null, expenseDate: new Date("2025-01-15") },
    { title: "Project Completion Reward", category: "REWARD" as Category, amount: 500.00, paymentMethod: "CASH" as PaymentMethod, paidTo: omar?.fullName ?? "Omar Karimi", paidBy: fatima?.fullName ?? "Finance", paidById: fatima?.id ?? null, paidToId: omar?.id ?? null, paidToContractorId: null, expenseDate: new Date("2025-01-20") },
    { title: "Safety Compliance Bonus", category: "BONUS" as Category, amount: 300.00, paymentMethod: "CASH" as PaymentMethod, paidTo: habib?.fullName ?? "Habib Qaderi", paidBy: fatima?.fullName ?? "Finance", paidById: fatima?.id ?? null, paidToId: habib?.id ?? null, paidToContractorId: null, expenseDate: new Date("2025-02-01") },
  ];
